defmodule KartVidsWeb.UserAuthTest do
  use KartVidsWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias KartVids.Accounts
  alias KartVidsWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KartVidsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KartVidsWeb.Endpoint.subscribe(live_socket_id)
