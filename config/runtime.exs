...
#
#     PHX_SERVER=true bin/kart_vids start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kart_vids, KartVidsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "www.kart-vids.com"
  ...
  config :kart_vids, KartVidsWeb.Endpoint,
    ...
    check_origin: ["https://www.kart-vids.com", "https://kart-vids.com", "https://kart-vids.fly.io"]
  ...
  #
  #     config :kart_vids, KartVids.Mailer,
